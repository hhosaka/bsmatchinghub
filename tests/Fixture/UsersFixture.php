...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'handlename' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'handlename' => 'Lorem ipsum dolor sit amet',
                'role' => 'Lorem ipsum do',
                'status' => 'Lorem ipsum dolor sit amet',
                'start_time' => 1586002333,
                'end_time' => 1586002333,
                ...
                'keyword14' => 1,
                'keyword15' => 1,
                'creation_date' => 1586002333,
                'modification_date' => 1586002333,
            ],
        ];
        parent::init();
    }
